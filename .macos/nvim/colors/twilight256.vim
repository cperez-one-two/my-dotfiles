...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "c5c8c6", "", "")

    " highlight groups
    call <SID>X("Cursor", "ffffff", "d0d0d0", "")
    call <SID>X("VertSplit", "c2bfa5", "7f7f7f", "reverse")
    call <SID>X("Folded", "575757", "1e1e1e", "bold")
    call <SID>X("FoldColumn", "d2b48c", "4d4d4d", "")
    call <SID>X("IncSearch", "708090", "f0e68c", "")
    call <SID>X("LineNr", "575757", "", "")
    call <SID>X("ModeMsg", "D4D4D4", "", "")
    call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "c2d2e4", "", "bold")
    ...
    call <SID>X("Visual", "D0D0D0", "3E3E3E", "reverse")
    "call <SID>X("PMenu", "1e1e1e", "a7a7a7", "reverse")
    call <SID>X("WildMenu", "1e1e1e", "a7a7a7", "reverse")
    "VisualNOS
    call <SID>X("WarningMsg", "cf6a4c", "", "")
    "WildMenu
    "Menu
    "Scrollbar
    "Tooltip
    ...
    "Error
    call <SID>X("Todo", "F4DE3b", "3e3e3e", "reverse")
